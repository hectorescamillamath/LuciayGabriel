...
function generateQuestion() {
  ...
  switch (op) {
    ...
    case 'multiplicacion':
      // Factores más pequeños para que sea manejable
      const multMax = d <= 2 ? 9 : d === 3 ? 12 : d === 4 ? 15 : 20;
      a = randInt(1, multMax);
      b = randInt(1, multMax);
      answer = a * b;
      symbol = '×';
    ...
    case 'division':
      ...
      b = randInt(1, d <= 2 ? 9 : d === 3 ? 12 : d === 4 ? 15 : 20);
      answer = randInt(1, d <= 2 ? 9 : d === 3 ? 12 : 15);
      a = b * answer;
      symbol = '÷';
      break;
  }
...
function handleCorrect() {
  ...
  // Subir dificultad cada 3 aciertos (máximo 5)
  if (STATE.questionCount >= 3 && STATE.difficulty < 5) {
    STATE.difficulty++;
    STATE.questionCount = 0;
